package com.haliyang.yangclock;
...
public class Alarms {
	...
	public static final String PACKGAE_NAME = "com.haliyang.yangclock";

    // This action triggers the AlarmReceiver as well as the AlarmKlaxon. It
    // is a public action used in the manifest for receiving Alarm broadcasts
    // from the alarm manager.
    public static final String ALARM_ALERT_ACTION = PACKGAE_NAME + ".ALARM_ALERT";
    ...
    public static final String ALARM_DONE_ACTION = PACKGAE_NAME + ".ALARM_DONE";
    ...
    public static final String ALARM_SNOOZE_ACTION = PACKGAE_NAME + ".ALARM_SNOOZE";

    // AlarmAlertFullScreen listens for this broadcast intent, so that other applications
    // can dismiss the alarm (after ALARM_ALERT_ACTION and before ALARM_DONE_ACTION).
    public static final String ALARM_DISMISS_ACTION = PACKGAE_NAME + ".ALARM_DISMISS";
